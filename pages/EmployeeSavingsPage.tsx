...
const EmployeeSavingsPage: React.FC = () => {
    const sections = [
        { id: 'what-is-it', title: "Qu'est-ce que c'est ?" },
        { id: 'how-to-fund', title: 'Comment l\'alimenter ?' },
        { id: 'employee-advantages', title: 'Avantages Salariés' },
        { id: 'company-advantages', title: 'Avantages Entreprise' },
        { id: 'early-release', title: 'Déblocage Anticipé' }
    ];
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            for (const section of sections) {
             ...
             if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 5) { // at the bottom
  ...
  return (
    <>
      <SubNav sections={sections} activeSection={activeSection} />
      <div className="bg-white/80 backdrop-blur-md p-8 rounded-xl shadow-lg">
        ...
        <ContentSection id={sections[0].id} title="Qu'est-ce que l'épargne salariale ?" icon="fa-briefcase">
        ...
        <ContentSection id={sections[1].id} title="Comment alimenter son plan ?" icon="fa-piggy-bank">
        ...
        <ContentSection id={sections[2].id} title="Avantages pour les salariés" icon="fa-gift">
          <ul>
        ...
        <ContentSection id={sections[3].id} title="Avantages pour l'entreprise" icon="fa-building">
          <ul>
        ...
        <ContentSection id={sections[4].id} title="Cas de déblocage anticipé" icon="fa-unlock-alt">
